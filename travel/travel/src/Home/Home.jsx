    ...
    <div className={`min-h-screen ${darkMode ? 'bg-gray-900 text-white' : 'bg-gray-50 text-gray-900'} relative`}>
      ...
      <nav className="flex items-center justify-between p-6 max-w-7xl mx-auto sticky top-0 z-40 bg-white/80 dark:bg-gray-900/80 backdrop-blur-md border-b border-gray-200 dark:border-gray-700">
        ...
        <div className="hidden md:flex space-x-8">
          ...
          <a href="#locations" className="text-gray-600 dark:text-gray-300 transition-all duration-300 hover:text-blue-600 dark:hover:text-blue-400 hover:scale-105 font-medium">Destinations</a>
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          >
            {[
              ...
              { 
                quote: "Best travel agency I've worked with. They understood exactly what we wanted and delivered beyond expectations.", 
                author: "David Wilson",
      ...
      {/* Map Section */}
      <section id="locations" className="py-16 bg-white dark:bg-gray-900">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
          ...
          <div className="rounded-xl overflow-hidden shadow-xl">
            <MapContainer center={[20, 0]} zoom={2} className="w-full h-96">
              ...
              <Marker position={[-8.4095, 115.1889]}>
                <Popup>
                  <div className="text-gray-800">
                    <h3 className="font-bold mb-1">Bali, Indonesia</h3>
                    <p className="text-sm">Tropical paradise with vibrant culture</p>
                  </div>
                </Popup>
              </Marker>
              <Marker position={[36.3932, 25.4615]}>
                <Popup>
                  <div className="text-gray-800">
                    <h3 className="font-bold mb-1">Santorini, Greece</h3>
                    <p className="text-sm">Stunning sunsets and white architecture</p>
                  </div>
                </Popup>
              </Marker>
            </MapContainer>
        ...
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-2 max-w-md mx-auto">
            <input 
              ...
              className="flex-1 px-4 py-3 rounded-lg border border-gray-300 dark:border-gray-600 focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white dark:bg-gray-700" 
            />
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="#locations" className="text-gray-400 hover:text-white transition-colors">Destinations</a></li>
